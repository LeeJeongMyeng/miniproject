...
public interface FleamarketDao {
    ...
    public FleamarketDto get_FleaMarket(int post_id);
    public List<Fleamarket_Files> get_FleaMarket_files(int post_id);
    public int del_FleaMarket(int post_id);
    public void del_FleaMarket_files(int post_id);
    ...
    public void del_Application_FM(int post_id);
    ...
    public int get_Application_count(int post_id);
